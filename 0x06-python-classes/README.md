...
**Reminder**: `size` is a private attribute. We did that to make sure we control the type and value. _Getter_ and _setter_ methods are not 100% Python, but more OOP. With them, you will be able to validate the assignment of a private attribute and also define how getting the attribute value will be available from outside - by copy? by assignment? etc. Also, adding _type/value_ validation in the setter will centralize the logic, since you will do it in only one place.
