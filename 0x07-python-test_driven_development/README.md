...
[3. Print square](./4-print_square.py) [4-print_square.txt](./tests/4-print_square.txt)
...
[4. Text indentation](./5-text_indentation.py) [5-text_indentation.txt](./tests/5-text_indentation.txt)
...
[6. Matrix multiplication](./100-matrix_mul.py) [100-matrix_mul.txt](./tests/100-matrix_mul.txt)
...
- Read: [Unicode HOW TO](https://docs.python.org/3.4/howto/unicode.html)
